...
const en = {
  ...
  filter_pending: "Catching",
  show_neighbourhoods: "Neighbourhoods",
  legend_pending: "Catching (in progress)",

  // TNR catching workflow
  tnr_pending_label: "Currently catching for TNR",
  status_label: "Status",
  status_needs_tnr: "Needs TNR",
  status_pending: "Catching for TNR",
  status_tnr_vacc: "TNR'd & vaccinated",
  status_tnr_only: "TNR'd",
  status_deceased: "Deceased",
  mark_start_catching: "Start catching for TNR",
  mark_returned: "Returned — mark TNR'd & vaccinated",
  cancel_catching: "Cancel catching",
  confirm_deceased: "Mark this dog as deceased? It will be archived and removed from the active map.",
  mark_injured_on: "Mark injured",
  mark_injured_off: "Clear injured",
...
const ar: Dict = {
  ...
  filter_injured: "مصاب",
  filter_pending: "قيد الإمساك",
  show_neighbourhoods: "الأحياء",
  legend_pending: "قيد الإمساك (جارٍ)",

  // TNR catching workflow
  tnr_pending_label: "قيد الإمساك للتعقيم حالياً",
  status_label: "الحالة",
  status_needs_tnr: "بحاجة للتعقيم",
  status_pending: "قيد الإمساك للتعقيم",
  status_tnr_vacc: "تم التعقيم والتطعيم",
  status_tnr_only: "تم التعقيم",
  status_deceased: "متوفّى",
  mark_start_catching: "بدء الإمساك للتعقيم",
  mark_returned: "عاد — تأكيد التعقيم والتطعيم",
  cancel_catching: "إلغاء الإمساك",
  confirm_deceased: "تسجيل هذا الكلب كمتوفّى؟ سيُؤرشَف ويُزال من الخريطة النشطة.",
  mark_injured_on: "تحديد كمصاب",
  mark_injured_off: "إزالة الإصابة",
